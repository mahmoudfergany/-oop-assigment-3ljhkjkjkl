...
void menu () {
    ...
    cout << endl;
    cout << "Enter the number of game you eant to play : " << endl;
}
...
void process() {
    ...
    if (number_of_play == 7) {
        ...
        int type;
        cout << "Enter the Type of your opposite : \n 1-HUMAN \n 2-COMPUTER : ";
        cin >> type;
        ...
        if (type == 1) {
            p1 = ui.create_player(name1,'X',PlayerType::HUMAN);
            p2 = ui.create_player(name2,'O',PlayerType::HUMAN);
        }
        else if (type == 2) {
            p1 = ui.create_player(name1,'X',PlayerType::HUMAN);
            p2 = ui.create_player(name2,'O',PlayerType::COMPUTER);
        }
